...
const Sidebar = () => {
  ...
  return (
    <aside className='h-full w-20 lg:w-72 border-base-300
        ...
        {filteredUser.map((user) => (
          ...
          >
            <div className="relative mx-auto lg:mx-0">
              <img
                src={user.profilePic || "https://tse3.mm.bing.net/th/id/OIP.dxLact-AwiLljWcE6sQcuwHaHa?r=0&w=3873&h=3873&rs=1&pid=ImgDetMain&o=7&rm=3"}
                alt={user.name}
