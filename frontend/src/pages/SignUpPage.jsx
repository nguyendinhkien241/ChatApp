        ...
        <div className='w-full max-w-md space-y-8'>
          ...
          <div className='text-center mb-8'>
            <div className='flex flex-col item-center gap-2 group'>
              ...
              group-hover:bg-primary/20 transition-color'>
                <MessageSquare className='size-6 text-primary'/>
              </div>
              <h1 className='text-2xl font-bold mt-2'>Create Account</h1>
              <p className='text-base-content/60'>Get started with your face account</p>
            </div>
          </div>
          {/* Form */}
          <form action="" className='space-y-6'>
            ...
            <div className='form-control'>
              ...
              <div className='relative'>
                ...
                <button
                  type='button'
                  className='z-2 absolute inset-y-0 right-0 pr-3 flex items-center'
